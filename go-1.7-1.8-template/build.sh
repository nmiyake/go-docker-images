...
ENV GOLANG_1_7_DOWNLOAD_SHA256 {{GO_1_7_LINUX_SHA256}}
...
ENV GOLANG_1_8_DOWNLOAD_SHA256 {{GO_1_8_LINUX_SHA256}}
...
dockerfile_content="${dockerfile_content//\{\{GO_1_8_LINUX_SHA256\}\}/$GO_1_8_LINUX_AMD64_SHA256}"
dockerfile_content="${dockerfile_content//\{\{GO_1_7_VERSION\}\}/$GO_1_7}"
dockerfile_content="${dockerfile_content//\{\{GO_1_7_LINUX_SHA256\}\}/$GO_1_7_LINUX_AMD64_SHA256}"
